...
public class NonBlazeProducerSuppressor implements StartupActivity {
  ...
  private static final ImmutableList<Class<? extends RunConfigurationProducer<?>>>
      PRODUCERS_TO_SUPPRESS =
          ImmutableList.of(
              org.rust.cargo.runconfig.command.CargoExecutableRunConfigurationProducer.class,
              org.rust.cargo.runconfig.command.CompositeCargoRunConfigurationProducer.class,
              org.rust.cargo.runconfig.test.CargoBenchRunConfigurationProducer.class,
              org.rust.cargo.runconfig.test.CargoTestRunConfigurationProducer.class);
