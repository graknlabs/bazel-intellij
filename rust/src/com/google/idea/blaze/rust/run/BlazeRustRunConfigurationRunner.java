...
import com.google.idea.blaze.base.ideinfo.RustIdeInfo;
...
public class BlazeRustRunConfigurationRunner implements BlazeCommandRunConfigurationRunner {
    ...
    /**
     * Converts to the native Rust plugin debug configuration state
     */
    static class BlazeRustDummyRunProfileState implements RunProfileState {
        final BlazeCommandRunConfiguration configuration;

        BlazeRustDummyRunProfileState(BlazeCommandRunConfiguration configuration) {
        ...
        CargoRunStateBase toNativeState(ExecutionEnvironment env) throws ExecutionException {
            ...
            CargoCommandConfiguration nativeConfig = (CargoCommandConfiguration)
...
//  }
    ...
    public RunProfileState getRunProfileState(Executor executor, ExecutionEnvironment env) {
        ...
        return new BlazeRustDummyRunProfileState(configuration);
    }
    ...
    /**
     * Builds blaze Rust target and returns the output build artifact.
     *
...
//            }
        ...
        try (BuildResultHelper buildResultHelper = BuildResultHelperProvider.createForLocalBuild(project)) {
            ListenableFuture<BuildResult> buildOperation = BlazeBeforeRunCommandHelper.runBlazeCommand(
...
//                        BlazePyDebugHelper.getAllBlazeDebugFlags(configuration.getProject(), target),
            ...
            return new RustExecutionInfo(file, args);
        }
    }
